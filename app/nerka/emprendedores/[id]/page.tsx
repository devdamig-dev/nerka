...
export default function EntrepreneurProfilePage() {
  ...
  return (
    <main className="pb-20 lg:px-8 lg:py-8 lg:pb-8">
      <div className="lg:grid lg:grid-cols-[minmax(0,1fr)_320px] lg:gap-6">
        ...
        <aside className="hidden lg:block">
          <div className="sticky top-24 space-y-4 rounded-2xl border border-[#ece8f7] bg-white p-4">
            ...
            <p className="text-sm text-[#6F6A7C]">Zona: {entrepreneur.zone}</p>
            <p className="text-sm text-[#6F6A7C]">{entrepreneur.responseTime}</p>
      ...
      <div className="fixed bottom-18 left-0 right-0 z-30 px-4 lg:hidden">
